...
report_constraint -all_violators -significant_digits 4 > ../results/johnson.max_constr.rpt
report_timing -delay_type max -nworst 40 -significant_digits 4 > ../results/johnson.max_timing.rpt

write_sdf ../results/johnson.max.sdf
